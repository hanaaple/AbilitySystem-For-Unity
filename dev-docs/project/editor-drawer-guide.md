...
> 상위 컨벤션(범용/전용 분리·과설계 지양)은 [`CODE_CONVENTION.md`](CODE_CONVENTION.md)의 "설계 원칙"·"에디터 확장" 참고.
...
조립한다. 스코프·정책이 갈리면 먼저 확인한다([`../agent/session-protocol.md`](../agent/session-protocol.md) '작업 중').
